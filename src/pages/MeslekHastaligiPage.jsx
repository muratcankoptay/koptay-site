...
const MeslekHastaligiPage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 pt-32 pb-12 px-4 font-sans text-slate-800">
            ...
            <HesaplamaDisclaimer
                aracAdi="meslek hastalığı tazminat hesaplama aracı"
                mevzuat="5510 sayılı Sosyal Sigortalar ve Genel Sağlık Sigortası Kanunu m.14, 6098 sayılı Türk Borçlar Kanunu"
                ekNotlar={[
                    'Yükümlülük süresi (5510 SK m.14) tespiti silikosis, asbestos ve diğer mesleki hastalıklarda kritik öneme sahiptir; bu hesap araç içindeki seçime göre yapılır.',
                    'TRH-2010 yaşam tablosu, asgari ücret, kıdem tavanı ve aktüer formüller dönemsel olarak güncellenir.',
                    'SGK PSD (peşin sermaye değeri) mahsubu sonucu doğrudan etkiler; nihai miktar mahkeme tarafından atanan aktüer bilirkişi tarafından belirlenir.',
                ]}
            />
        </div>
    );
