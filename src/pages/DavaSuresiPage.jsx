  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
      <div className="flex items-center gap-3 mb-6">
        <div className="bg-primary-100 text-primary-700 w-10 h-10 rounded-lg flex items-center justify-center">
...
const ZamanasimiSonucKarti = ({ sonuc }) => {
  ...
  if (sonuc.ozelDurum) {
    return (
      <div className="mt-6 bg-primary-50 border-l-4 border-primary-500 p-6 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-primary-700">{sonuc.not}</p>
          </div>
        </div>
      </div>
    );
