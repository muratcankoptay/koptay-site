        ...
        <div className="min-h-screen bg-slate-50 pt-32 pb-12 px-4 font-sans text-slate-800">
            ...
            <div className="container mx-auto px-4 py-4 flex justify-between items-center bg-white border-b border-slate-200 rounded-md shadow-sm mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl md:text-3xl font-serif font-light text-slate-800 tracking-tight">İş Kazası Tazminat Hesaplama 2026</h1>
            ...
            <HesaplamaDisclaimer
                aracAdi="iş kazası tazminat hesaplama aracı"
                mevzuat="5510 sayılı Sosyal Sigortalar ve Genel Sağlık Sigortası Kanunu, 6098 sayılı Türk Borçlar Kanunu m.49-56"
                ekNotlar={[
